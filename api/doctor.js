...
export const RECENT_COLUMNS = [
  ...
  ["profiles", "stripe_customer_id", "0010_billing.sql"],
  ["profiles", "stripe_subscription_id", "0010_billing.sql"],
  ["profiles", "plan_until", "0010_billing.sql"],
  ["profiles", "stripe_event_id", "0010_billing.sql"],
